...
def parse_openeuler_component_url(url):
    ...
    if 'oe' in comp_version_arch and comp_version_arch[comp_version_arch.index("oe")+1].isdigit():
        ...
        print(f"revision_part,{revision_part}")
...
if __name__ == "__main__":
    ...
    url = "https://archive.fedoraproject.org/pub/archive/fedoraa/linux/core/4/ppc/os/fedora/rpms/rp-pppoe-3.5-27.ppc.rpm"
    url = "https://dl-cdn.openeuler.openatom.cn/openEuler-22.03-LTS-SP1/source/Packages/ros-noetic-ros-nodelet_core-1.10.1-1.src.rpm"
    comp_name, version = parse_openeuler_component_url(url)
